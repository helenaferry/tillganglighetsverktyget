...
:host .digi-typography-heading-jumbo {
  font-size: var(--digi--typography--heading-jumbo--font-size--desktop);
  font-family: var(--digi--global--typography--font-family--default);
  color: var(--digi--color--text--primary, --digi--color--text--primary);
  font-weight: var(--digi--typography--heading-jumbo--font-weight--desktop);
}
@media (min-width: 62rem) {
  :host .digi-typography-heading-jumbo {
    font-size: var(--digi--typography--heading-jumbo--font-size--desktop-large);
  }
}
:host .digi-typography-heading-jumbo--secondary {
  color: var(--digi--grayscale-0);
}
:host .digi-typography-heading-jumbo::after {
  content: "";
  width: 11.875rem;
  height: 0.4375rem;
  background: var(--digi--color--background--inverted-1);
  display: block;
  margin-top: var(--digi--padding--small);
}
@media (min-width: 62rem) {
  :host .digi-typography-heading-jumbo::after {
    width: 13.75rem;
    margin-top: var(--digi--margin--h2-large);
    height: 0.625rem;
  }
}
:host .digi-typography-heading-jumbo--secondary::after {
  background: var(--digi--leaf-500);
}
digi-typography :host .digi-typography-heading-jumbo {
