...
@media (max-width: 36rem) {
  :host .digi-tools-feedback-banner__heading {
    font-size: var(--digi--typography--heading-2--font-size--mobile);
    font-weight: var(--digi--typography--heading-2--font-weight--mobile);
  }
}
:host .digi-tools-feedback-banner--grid {
  display: grid;
...
:host .digi-tools-feedback-banner__container {
  padding-top: var(--digi--padding--largest);
  padding-bottom: var(--digi--padding--largest-2);
}
@media (max-width: 36rem) {
  :host .digi-tools-feedback-banner__container {
    padding: var(--digi--padding--large) var(--digi--padding--medium) var(--digi--padding--largest-2) var(--digi--padding--medium);
  }
}
:host .digi-tools-feedback-banner__illustration {
  flex-basis: 4.25rem;
  padding-left: var(--digi--padding--large);
}
@media (max-width: 36rem) {
  :host .digi-tools-feedback-banner__illustration {
    padding-left: var(--digi--padding--smaller);
  }
}
:host .digi-tools-feedback-banner__main-content {
  display: inline-flex;
  padding-bottom: var(--digi--padding--largest);
}
:host .digi-tools-feedback-banner__text-content {
  flex-basis: 17.6875rem;
}
@media (max-width: 36rem) {
  :host .digi-tools-feedback-banner__links {
    display: flex;
    flex-direction: column;
  }
}
:host .digi-tools-feedback-banner digi-link-external {
  padding-right: var(--digi--padding--large);
}
@media (max-width: 36rem) {
  :host .digi-tools-feedback-banner digi-link-external {
