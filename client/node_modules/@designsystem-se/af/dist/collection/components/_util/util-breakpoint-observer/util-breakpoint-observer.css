...
:host .digi-util-breakpoint-observer {
  --SMALL: small;
  --MEDIUM: medium;
  --LARGE: large;
  --XLARGE: xlarge;
}
:host .digi-util-breakpoint-observer__observer {
  --digi--util-breakpoint-observer--breakpoint: var(--SMALL);
  border: 0;
  clip: rect(1px, 1px, 1px, 1px);
  -webkit-clip-path: inset(50%);
  clip-path: inset(50%);
...
@media (min-width: 48rem) {
  :host .digi-util-breakpoint-observer__observer {
    --digi--util-breakpoint-observer--breakpoint: var(--MEDIUM);
    transform: rotate(10deg);
  }
}
@media (min-width: 62rem) {
  :host .digi-util-breakpoint-observer__observer {
    --digi--util-breakpoint-observer--breakpoint: var(--LARGE);
    transform: rotate(20deg);
  }
}
@media (min-width: 75rem) {
  :host .digi-util-breakpoint-observer__observer {
    --digi--util-breakpoint-observer--breakpoint: var(--XLARGE);
