...
export class barChart {
    constructor() {
        ...
        this.setDims = (onlyHeight = false) => {
            ...
            const tempTitle = d3.select(this._titleDiv).node().getBoundingClientRect(), tempLegend = d3.select(this._legendDiv).node().getBoundingClientRect();
    ...
    initToolTip() {
        ...
        this._tooltip = d3.select('#' + this.afId);
    ...
    getTextSize(text) {
        const textWidth = [];
        const svg = d3.select(this._chartDiv).append('svg');
        svg
            .selectAll('dummyText')
            .data([text])
            .join('text')
    ...
    static get properties() {
        return {
            "afVariation": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "BarChartVariation",
                    "resolved": "BarChartVariation.Horizontal | BarChartVariation.Vertical",
                    "references": {
                        "BarChartVariation": {
                            "location": "import",
                            "path": "./bar-chart-variation.enum",
                            "id": "src/components/_chart/bar-chart/bar-chart-variation.enum.ts::BarChartVariation"
                        }
                    }
                },
                "required": false,
                ...
                "docs": {
                    "tags": [],
                    "text": "S\u00E4tter orienteringen p\u00E5 diagrammet, kan vara vertikalt eller horisontellt, vertikalt \u00E4r f\u00F6rvalt."
                },
                "getter": false,
                "setter": false,
                "attribute": "af-variation",
                "reflect": false,
                "defaultValue": "BarChartVariation.Vertical"
            },
            "afHeadingLevel": {
                "type": "string",
                "mutable": false,
                ...
                "docs": {
                    "tags": [],
                    "text": "En str\u00E4ng med rubrikniv\u00E5n du vill ha i diagrammet, default \u00E4r 'h3'"
                },
                "getter": false,
                "setter": false,
            ...
            "afId": {
                ...
                "docs": {
                    "tags": [],
                    "text": "(Frivillig) Om du vill att komponenten ska ha ett unikt ID, kan du skicka in detta h\u00E4r, annars genereras ett automatiskt"
                },
                "getter": false,
                "setter": false,
                "attribute": "af-id",
                "reflect": false,
                "defaultValue": "randomIdGenerator('tooltip')"
            },
            "afChartData": {
                "type": "string",
                "mutable": true,
                "complexType": {
                    "original": "ChartLineData | string",
                    "resolved": "ChartLineData | string",
                    "references": {
                        "ChartLineData": {
                            "location": "import",
                            "path": "../chart-line/chart-line-data.interface",
                            "id": "src/components/_chart/chart-line/chart-line-data.interface.ts::ChartLineData"
                        }
                    }
                },
                "required": false,
                ...
                "docs": {
                    "tags": [],
                    "text": "Datan som ska visas upp i stapeldiagrammet, kan vara av antingen typen ChartLineData, eller str\u00E4ngifierad ChartLineData"
                },
                "getter": false,
                "setter": false,
                "attribute": "af-chart-data",
                "reflect": false
            }
        };
    }
    ...
    static get watchers() {
        return [{
                "propName": "afChartData",
                "methodName": "afChartDataUpdate"
            }];
    }
}
