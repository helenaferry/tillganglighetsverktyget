...
* @prop --digi--header-navigation-item--font-family: var(--digi--global--typography--font-family--default);
* @prop --digi--header-navigation-item--font-size: var(--digi--typography--body--font-size--desktop);
* @prop --digi--header-navigation-item--color: var(--digi--color--text--primary);
* @prop --digi--header-navigation-item--color-hover: var(--digi--color--text--link);
* @prop --digi--header-navigation-item--color-active: var(--digi--color--text--link);
*/
:host {
  ...
  --digi--header-navigation-item-indicator--inactive--color: var(--digi--color--background--neutral-8);
  --digi--header-navigation-item-indicator--inactive-hover--color: var(--digi--color--background--neutral-6);
  --digi--header-navigation-item-indicator--active--color: var(--digi--leaf-500);
  display: block;
  --INDICATOR-COLOR: var(
...
:host ::slotted(a) {
  ...
  color: inherit;
  padding: 1rem;
  color: var(--digi--header-navigation-item--color);
  font-family: var(--digi--header-navigation-item--font-family);
  font-size: var(--digi--header-navigation-item--font-size);
}
:host ::slotted(a:hover),
:host ::slotted(a:active),
:host ::slotted(a:focus-visible) {
  background-color: var(--digi--color--background--neutral-6);
  color: var(--digi--header-navigation-item--color-hover);
  text-decoration: underline;
}
:host ::slotted(a:hover) + .digi-header-navigation-item-indicator {
  --INDICATOR-COLOR: var(
    --digi--header-navigation-item-indicator--inactive-hover--color
  );
}
:host ::slotted(a:hover) + .digi-header-navigation-item-indicator--active {
  --INDICATOR-COLOR: var(
...
.digi-header-navigation-item-indicator {
  height: 0.25rem;
  width: 100%;
  background-color: var(--INDICATOR-COLOR);
}
.digi-header-navigation-item-indicator--active {
  --INDICATOR-COLOR: var(
    --digi--header-navigation-item-indicator--active--color
  );
}

.digi-header-navigation-item--active ::slotted(a) {
  font-weight: bold;
}