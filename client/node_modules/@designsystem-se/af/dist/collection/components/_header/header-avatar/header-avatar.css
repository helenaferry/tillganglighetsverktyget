...
* @prop --digi--header-avatar--margin: var(--digi--gutter--medium);
* @prop --digi--header-avatar--font-family: var(--digi--global--typography--font-family--default);
* @prop --digi--header-avatar--font-size: var(--digi--typography--label--font-size--desktop);
* @prop --digi--header-avatar--line-height: var(--digi--typography--label--line-height--desktop);
* @prop --digi--header-avatar--color: var(--digi--color--text--primary);
*/
:host {
...
:host .digi-header-avatar {
  display: flex;
  align-items: center;
  font-family: var(--digi--header-avatar--font-family);
  color: var(--digi--header-avatar--color);
  font-weight: var(--digi--typography--title-logo--font-weight--desktop);
  font-size: var(--digi--header--font-size);
}
:host .digi-header-avatar__image {
  display: block;
  height: 32px;
}
:host .digi-header-avatar__image * img {
  border-radius: 100%;
}
:host .digi-header-avatar__placeholder {
  background: #ddd;
  border-radius: 100%;
  height: 32px;
  width: 32px;
