...
const UtilBreakpointObserver = class {
    constructor(hostRef) {
        ...
        this.afOnSmall = index.createEvent(this, "afOnSmall", 7);
        this.afOnMedium = index.createEvent(this, "afOnMedium", 7);
        this.afOnLarge = index.createEvent(this, "afOnLarge", 7);
        this.afOnXLarge = index.createEvent(this, "afOnXLarge", 7);
    }
    componentDidLoad() {
    ...
    handleBreakpoint(e) {
        ...
        switch (value) {
            case utilBreakpointObserverBreakpoints_enum.UtilBreakpointObserverBreakpoints.SMALL:
                this.afOnSmall.emit({ value, e });
                break;
            case utilBreakpointObserverBreakpoints_enum.UtilBreakpointObserverBreakpoints.MEDIUM:
                this.afOnMedium.emit({ value, e });
                break;
            case utilBreakpointObserverBreakpoints_enum.UtilBreakpointObserverBreakpoints.LARGE:
                this.afOnLarge.emit({ value, e });
                break;
            case utilBreakpointObserverBreakpoints_enum.UtilBreakpointObserverBreakpoints.XLARGE:
                this.afOnXLarge.emit({ value, e });
        }
    }
    render() {
        return (index.h(index.Host, { key: '27e2c889cf3dda1e6e3219f11174132d4a41551e' }, index.h("div", { key: '9533b0f73c646c6fa08db048129f4b6b808afbb9', class: "digi-util-breakpoint-observer" }, index.h("div", { key: '99807ba154fa505833549838992b55ddc700ed77', ref: (el) => (this._observer = el), onTransitionEnd: (e) => this.handleBreakpoint(e), class: "digi-util-breakpoint-observer__observer" }), index.h("slot", { key: '91ea7ebbe13986cd9904c14256168acf2153745b' }))));
    }
