...
const iconExternalLinkAltCss = ".sc-digi-icon-external-link-alt-h{--digi--icon--color:var(--digi--color--icons--primary);--digi--icon--width:initial;--digi--icon--height:auto;display:flex;min-height:1.4em;align-items:center}.sc-digi-icon-external-link-alt-h svg.sc-digi-icon-external-link-alt{color:var(--digi--icon--color);max-width:var(--digi--icon--width);max-height:var(--digi--icon--height);width:var(--digi--icon--width, auto);height:var(--digi--icon--height, auto)}";
const DigiIconExternalLinkAltStyle0 = iconExternalLinkAltCss;

const IconExternalLinkAlt = class {
    constructor(hostRef) {
    ...
    render() {
        return (index.h("svg", { key: '69a052efdc5c30a180cb208e55c2450b9ff67583', class: "digi-icon-external-link-alt", width: "29", height: "26", viewBox: "0 0 29 26", xmlns: "http://www.w3.org/2000/svg", "aria-hidden": this.afSvgAriaHidden ? 'true' : 'false', "aria-labelledby": this.afSvgAriaLabelledby
                ? this.afSvgAriaLabelledby
                : this.afTitle
                    ? this.titleId
                    : undefined }, this.afTitle && index.h("title", { key: '0d3010546c53faf8e3e74d27af4cde7e35d0020f', id: this.titleId }, this.afTitle), this.afDesc && index.h("desc", { key: 'cee7afb9c6a224563c7df092e2e9c7593fa46101' }, this.afDesc), index.h("path", { key: 'fcefd5622c55e446a00d5fb3dccb1aad346846ce', class: "digi-icon-external-link-alt__shape", d: "M22.556 12.28v11.283A2.427 2.427 0 0120.139 26H2.417A2.427 2.427 0 010 23.562V5.688A2.427 2.427 0 012.417 3.25h17.117c.538 0 .807.656.427 1.04L18.752 5.51a.602.602 0 01-.427.178H2.72a.303.303 0 00-.302.305v17.266c0 .168.135.305.302.305h17.118a.303.303 0 00.302-.305v-9.76c0-.16.064-.316.177-.43l1.208-1.219a.604.604 0 011.032.431zM28.396 0h-6.847c-.536 0-.807.657-.427 1.04l2.426 2.448L9.844 17.311a.613.613 0 000 .862l1.139 1.149a.6.6 0 00.854 0L25.542 5.499l2.427 2.447A.604.604 0 0029 7.516V.608C29 .273 28.73 0 28.396 0z", fill: "currentColor", "fill-rule": "nonzero" })));
    }
};
IconExternalLinkAlt.style = DigiIconExternalLinkAltStyle0;
...
const DigiLinkExternalStyle0 = linkExternalCss;
...
const LinkExternal = class {
    ...
    render() {
        return (index.h(index.Host, { key: '4946a478c5576a76adf11bdb3f7a6d470535c21b' }, index.h("digi-link", { key: 'f616c042f1ff39b607bfcdd679b966ddbdc7b3b9', class: Object.assign({ 'digi-link-external': true }, this.cssModifiers), afVariation: this.afVariation, afHref: this.afHref, onAfOnClick: (e) => this.clickLinkHandler(e), afTarget: this.afTarget, afDescribedby: this.afDescribedby, afAriaLabel: this.afAriaLabel }, index.h("digi-icon-external-link-alt", { key: 'a0629a756f97ada2ee304edad87d3daac6926726', class: "digi-link-external__icon", "aria-hidden": "true", slot: "icon" }), index.h("slot", { key: '12fcb4d4cb80d991162130a076728e9acb8fdc67' }))));
    }
    get hostElement() { return index.getElement(this); }
};
LinkExternal.style = DigiLinkExternalStyle0;

exports.digi_icon_external_link_alt = IconExternalLinkAlt;
