...
require('./typography-variation.enum-5b035b3b.js');
...
const FormSelectFilter = class {
    constructor(hostRef) {
        ...
        this.afValidation = toolsFeedbackVariation_enum.FormSelectFilterValidation.NEUTRAL;
    ...
    setTabIndex() {
        ...
        if (!tabindexes) {
            logger_util.logger.warn(`No input elements was found to set tabindex on.`, this.hostElement);
            return;
        }
    ...
    updateTabIndex(element) {
        if (!element) {
            logger_util.logger.warn(`No input element was found to update tabindex on.`, this.hostElement);
            return;
        }
    ...
    get cssModifiers() {
        return {
            ...
            'digi-form-select-filter--neutral': this.afValidation === toolsFeedbackVariation_enum.FormSelectFilterValidation.NEUTRAL,
            'digi-form-select-filter--success': this.afValidation === toolsFeedbackVariation_enum.FormSelectFilterValidation.SUCCESS,
            'digi-form-select-filter--warning': this.afValidation === toolsFeedbackVariation_enum.FormSelectFilterValidation.WARNING,
            'digi-form-select-filter--error': this.afValidation === toolsFeedbackVariation_enum.FormSelectFilterValidation.ERROR
        };
    }
    ...
    render() {
        return (index.h("div", { key: '131d9bcd798a19ab4da264d59e7b2b938af39e4d', class: Object.assign({ 'digi-form-select-filter': true }, this.cssModifiers), role: "application", id: `${this.afId}-identifier` }, index.h("digi-form-label", { key: '6ad325b665d8d23ffb8bc926cec923a4f43cec77', afLabel: this.afFilterButtonTextLabel, afFor: `${this.afId}`, afId: `${this.afId}-label`, class: "digi-form-select-filter__label", afDescription: this.afDescription, afRequired: this.afRequired, afAnnounceIfOptional: this.afAnnounceIfOptional, afRequiredText: this.afRequiredText, afAnnounceIfOptionalText: this.afAnnounceIfOptionalText }), index.h("digi-util-keydown-handler", { key: 'd90ec9e07871d99e964036346a13d3dcf8bb98f3', onAfOnEsc: () => this.escHandler() }, index.h("button", { key: '1d64f4c3a76bc2d81a10b60e82ee7f5724192051', type: "button", id: `${this.afId}`, class: "digi-form-select-filter__toggle-button", onClick: () => this.toggleDropdown(), ref: (el) => (this._toggleButton = el), "aria-haspopup": "true", "aria-label": this.ariaLabel, "aria-labelledby": this.afFilterButtonAriaDescribedby, "aria-controls": `${this.afId}-dropdown-menu`, "aria-expanded": this.isOpen }, index.h("div", { key: '4c82b8b3dfd9a6c66bcbd852498eeabcd4aa5ccb', class: Object.assign({ 'digi-form-filter__toggle-button-wrapper': true }, this.cssModifiersToggleButtonWrapper) }, index.h("digi-icon-check", { key: '8b8d3ed48f8f7cfdc374ebf9d62da00891d15e06', class: Object.assign({ 'digi-form-select-filter__toggle-button-indicator': true }, this.cssModifiersToggleButtonIndicator), slot: "icon" }), index.h("span", { key: 'e35d0ae711a81e43886707bffaed3b10ecffb25d', class: "digi-form-select-filter__toggle-button-text" }, this.renderButtonLabel)), index.h("digi-icon-chevron-down", { key: 'dfe447e717e5c99d400390aaaacad6160d188928', class: "digi-form-select-filter__toggle-icon" })), index.h("div", { key: 'cd68ced3b7f00548e23a3d37e54bccbc3f7ca700', id: `${this.afId}-dropdown-menu`, class: {
            ...
            } }, index.h("fieldset", { key: '8cf2eedb7d23bcec85d761336f80c94665f8de8b' }, index.h("div", { key: '9e791ab8c6eea058919f01e6819d64c84a1958a5', class: "digi-form-select-filter__header" }, index.h("legend", { key: '8497b0c1517187628a3978697cf804fb4a647935', class: "digi-form-select-filter__legend" }, this.afFilterButtonTextLabel), index.h("digi-form-input", { key: '934ae7bc9be7b0d3a312dea866e21065246c1a84', afLabel: this.afName, afId: `${this.afId}-search`, afVariation: formInputVariation_enum.FormInputVariation.MEDIUM, afType: formInputType_enum.FormInputType.SEARCH, afValidation: formInputVariation_enum.FormInputValidation.NEUTRAL, onAfOnFocus: () => {
                this.focusListItemIndex = 0;
            }, onAfOnKeyup: (e) => {
                this.inputSearchKeyboardHandler(e.detail);
            }, onAfOnInput: (e) => this.inputSearchInputHandler(e.detail), afValue: this._searchQuery, class: "digi-form-select-filter__search-input", afAriaControls: `${this.afId}-select-filter-list`, afAutocomplete: "off", afAriaAutocomplete: "none" }), this.renderEmptyStateBox()), index.h("div", { key: '1768a9ad717b385f8a3c2c76d12c126009d97821', class: "digi-form-select-filter__scroll" }, index.h("digi-util-keydown-handler", { key: '55527df2cae38577b555155a03f50b1167eb8c65', onAfOnDown: (e) => this.downHandler(e), onAfOnRight: (e) => this.downHandler(e), onAfOnUp: (e) => this.upHandler(e), onAfOnLeft: (e) => this.upHandler(e), onAfOnHome: (e) => this.homeHandler(e), onAfOnEnd: (e) => this.endHandler(e), onAfOnEnter: (e) => this.enterHandler(e), onAfOnSpace: (e) => this.spaceHandler(e), onAfOnTab: () => this.tabHandler(), onAfOnShiftTab: () => this.shiftHandler() }, index.h("ul", { key: '7898741e2835ef7362a240feacd421aa843aedbb', class: "digi-form-select-filter__list", "aria-labelledby": `${this.afId}`, id: `${this.afId}-select-filter-list`, role: this.afMultipleItems ? '' : 'radiogroup', "aria-invalid": this.afMultipleItems
                ? 'false'
                : this.afValidation === toolsFeedbackVariation_enum.FormSelectFilterValidation.ERROR
                    ? 'true'
                    : 'false', "aria-errormessage": `${this.afId}--validation-message`, "aria-required": this.afMultipleItems
                ? false
                : this.afRequired
                    ? 'true'
                    : 'false' }, this.showNeutralValue && (index.h("li", { key: '5cc7d76c73e0029bd050417798bfc9b023132ee5', class: "digi-form-select-filter__item", role: "radio", "aria-required": this.afMultipleItems
                ? 'false'
                : this.afRequired
                    ? 'true'
            ...
            this._filteredResult.map((item, index$1) => {
                return (index.h("li", { class: "digi-form-select-filter__item", key: index$1, dir: item.dir, lang: item.lang, "aria-checked": this.isSelected(item.value) ? 'true' : 'false', role: this.afMultipleItems ? 'checkbox' : 'radio', "aria-required": this.afMultipleItems
                        ...
                        ? this.afValidation ===
                            toolsFeedbackVariation_enum.FormSelectFilterValidation.ERROR
                            ? 'true'
                            : 'false'
