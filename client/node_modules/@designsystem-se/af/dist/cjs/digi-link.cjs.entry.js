...
const linkVariation_enum = require('./link-variation.enum-e6d243b1.js');
...
const Link = class {
    constructor(hostRef) {
        ...
        this.afVariation = linkVariation_enum.LinkVariation.SMALL;
    ...
    render() {
        return (index.h(index.Host, { key: '0edbce9cc8d2abd454df5c934afa4227922684b6', class: Object.assign({ 'digi-link': true }, this.cssModifiers) }, !this.afLinkContainer && (index.h("a", { key: '8b00c0c6b2cd28d391496552579890edf7d549aa', href: this.afHref, onClick: (e) => this.clickLinkHandler(e), target: this.afTarget, rel: this.relation, ref: (el) => (this._link = el), "aria-describedby": this.afDescribedby, "aria-label": this.afAriaLabel, download: this.afDownload }, this.hasIcon && (index.h("div", { key: '859232c9a55f0d8755a9429669473fe55fb3660e', class: "digi-link__icon-wrapper", "aria-hidden": "true" }, index.h("slot", { key: 'dfdb80c68baac0fefe2eb8bd3b098ca82d0f7d6e', name: "icon" }))), index.h("slot", { key: '55ff600ea8cfcf3828ea6ce6a26c0fc17a6f6fe5' }))), this.afLinkContainer && index.h("slot", { key: 'dbf012146e189b8a97af4ad1dc5b43c5704cd7df' })));
    }
...
Link.style = DigiLinkStyle0;

exports.digi_link = Link;
