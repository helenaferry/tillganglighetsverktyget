...
const ProgressIndicator = class {
    constructor(hostRef) {
        ...
        this.afRole = progressIndicatorVariation_enum.ProgressIndicatorRole.STATUS;
        this.afVariation = progressIndicatorVariation_enum.ProgressIndicatorVariation.PRIMARY;
        this.afId = randomIdGenerator_util.randomIdGenerator('digi-progress-indicator');
    }
    componentWillLoad() {
    ...
    getItems(update) {
        ...
        if (update) {
            ...
            items = this.hostElement.querySelectorAll('.digi-progress-indicator__slot li');
        }
        if (items.length > 0) {
    ...
    renderHeading() {
        return (index.h("h2", { class: "digi-progress-indicator__heading", tabIndex: -1, ref: (el) => (this.headingElement = el) }, this.afStepHeading));
    }
    get cssModifiers() {
        return {
            'digi-progress-indicator': true,
            'digi-progress-indicator--primary': this.afVariation === progressIndicatorVariation_enum.ProgressIndicatorVariation.PRIMARY,
            'digi-progress-indicator--secondary': this.afVariation === progressIndicatorVariation_enum.ProgressIndicatorVariation.SECONDARY,
    ...
    render() {
        return (index.h("div", { key: 'a8526805e4f6517a93cc3af35584440b8310a767', class: this.cssModifiers, role: this.afRole === progressIndicatorVariation_enum.ProgressIndicatorRole.STATUS
                ...
                visibility: this.afStepNextLabel !== null &&
                    ...
                    ? 'visible'
                    : 'hidden'
            } }, `${this.afStepNextText} ${this.afStepNextLabel}`)), this.afCompletedSteps === this.afTotalSteps && (index.h("p", { class: "digi-progress-indicator__next", style: {
                visibility: 'hidden'
            } }, `${this.afStepNextText} ${this.afStepNextLabel}`)))) : (index.h("div", { class: "digi-progress-indicator__content" }, this.renderHeading(), index.h("p", { class: "digi-progress-indicator__label" }, index.h("span", null, `${this.afStepText}`, " "), index.h("span", { class: "digi-progress-indicator__label--steps" }, `${this.afCompletedSteps} ${this.afStepsSeparator} ${this.afTotalSteps}`)))), !this.hasSlottedItems ? (index.h("ol", { class: "digi-progress-indicator__list", "aria-hidden": "true" }, this.totalSteps.map((item, i) => {
            return (index.h("li", { class: {
                    'digi-progress-indicator__step': true,
                    'digi-progress-indicator__step--active': this.afCompletedSteps > i,
                    'digi-progress-indicator__step--current': this.afCompletedSteps === i + 1,
                    'digi-progress-indicator__step--warning': this.afWarningStep === i + 1,
                    'digi-progress-indicator__step--error': this.afErrorStep === i + 1
                } }, index.h("span", { class: "digi-progress-indicator__step-indicator" }, this.afVariation ===
                progressIndicatorVariation_enum.ProgressIndicatorVariation.SECONDARY &&
                this.afCompletedSteps > i + 1 && (index.h("digi-icon-check", { class: "digi-progress-indicator__icon" })), this.afWarningStep === i + 1 && (index.h("digi-icon-validation-warning", { class: "digi-progress-indicator__icon--warning" })), this.afErrorStep === i + 1 && (index.h("digi-icon-validation-error", { class: "digi-progress-indicator__icon--error" })), index.h("span", { class: "digi-progress-indicator__step-number" }, item))));
        }))) : (index.h("ol", { class: "digi-progress-indicator__list", "aria-hidden": "true" }, this.listItems.map((item, index$1) => {
            return (index.h("li", { class: {
                    'digi-progress-indicator__step': true,
                    'digi-progress-indicator__step--active': item.checked || this.afCompletedSteps === index$1 + 1,
                    'digi-progress-indicator__step--current': this.afCompletedSteps === index$1 + 1
                } }, index.h("span", { class: "digi-progress-indicator__step-indicator" }, this.afVariation ===
                progressIndicatorVariation_enum.ProgressIndicatorVariation.SECONDARY &&
                item.checked &&
...
ProgressIndicator.style = DigiProgressIndicatorStyle0;

exports.digi_progress_indicator = ProgressIndicator;
