...
const List = class {
    constructor(hostRef) {
        ...
        this.afListType = listType_enum.ListType.BULLET;
    }
    componentWillLoad() {
        this.getListItems();
    }
    ...
    applyCheckedListStyling() {
        if (this.afListType === listType_enum.ListType.CHECKED) {
    ...
    getListItems() {
        ...
        if (!slotItems || slotItems.length <= 0) {
            ...
            this.listItems = [];
            logger_util.logger.warn(`The slot contains no <li> elements.`, this.hostElement);
            return;
        }
    ...
    get listElement() {
        return this.afListType === listType_enum.ListType.NUMBERED ? 'ol' : 'ul';
    }
    render() {
        const Tag = this.afListType === listType_enum.ListType.NUMBERED ? 'ol' : 'ul';
        const className = {
            'digi-list': true,
            [`digi-list--${this.afListType}`]: true
        };
        return (index.h("digi-typography", { key: 'cec688df7cdb9bcff52e98bf5ae33ba3ca8176d2' }, index.h(Tag, { key: 'e9bd20b77dbbd72ad5477fad1caf3f10e88db327', class: className }, index.h("slot", { key: '45981df4d7211feb9240d84fbedc9a6b235a87b6' }))));
    }
    get hostElement() { return index.getElement(this); }
};
List.style = DigiListStyle0;

exports.digi_list = List;
