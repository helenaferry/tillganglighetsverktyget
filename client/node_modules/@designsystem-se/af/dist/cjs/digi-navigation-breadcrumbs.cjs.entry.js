...
const NavigationBreadcrumbs = class {
    ...
    getBreadcrumbs() {
        ...
        if (!elements || (elements === null || elements === void 0 ? void 0 : elements.length) <= 0) {
            logger_util.logger.warn(`The slot contains no link elements.`, this.hostElement);
            return;
        }
    ...
    render() {
        var _a;
        return (index.h("nav", { key: '8d4f11e378e2e3c76a5986ac815572db4e42d1c6', class: "digi-navigation-breadcrumbs", "aria-label": this.afAriaLabel }, index.h("ol", { key: '97e85957fea1c91b1ce36c6e4e57c106d64f42b8', class: "digi-navigation-breadcrumbs__items" }, this.linkItems.map((item) => {
            return (index.h("li", { class: "digi-navigation-breadcrumbs__item" }, index.h("a", { class: "digi-navigation-breadcrumbs__link", onClick: (e) => this.clickHandler(e), href: item.href }, item.text)));
        }), index.h("li", { key: '990d80f432ade5087039ce785e4575c9eeaaf6bb', class: "digi-navigation-breadcrumbs__item", "aria-current": "page" }, (_a = this.currentPage) !== null && _a !== void 0 ? _a : this.afCurrentPage), index.h("digi-util-mutation-observer", { key: 'f52581946b6c6f4dce3f2f3fad07147c718f815a', onAfOnChange: () => this.getBreadcrumbs(), ref: (el) => (this._observer = el), hidden: true }, index.h("slot", { key: '7d8f501fad20ab4cfcb239b0d6660a452327f907' })))));
    }
    get hostElement() { return index.getElement(this); }
    static get watchers() { return {
        "afCurrentPage": ["onAfCurrentPage"]
    }; }
};
NavigationBreadcrumbs.style = DigiNavigationBreadcrumbsStyle0;

exports.digi_navigation_breadcrumbs = NavigationBreadcrumbs;
