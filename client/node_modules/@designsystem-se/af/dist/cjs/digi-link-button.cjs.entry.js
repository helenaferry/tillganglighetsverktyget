...
const LinkButton = class {
    constructor(hostRef) {
        ...
        this.afVariation = linkButtonVariation_enum.LinkButtonVariation.PRIMARY;
        this.afSize = linkButtonVariation_enum.LinkButtonSize.MEDIUM;
        this.afOverrideLink = false;
        this.afLinkContainer = false;
        this.afHideIcon = false;
    ...
    setHasNotification() {
        const notification = !!this.hostElement.querySelector('[slot="notification"]');
        if (notification) {
    ...
    get cssModifiers() {
        return {
            'digi-link-button--primary': this.afVariation === linkButtonVariation_enum.LinkButtonVariation.PRIMARY,
            'digi-link-button--secondary': this.afVariation === linkButtonVariation_enum.LinkButtonVariation.SECONDARY,
            'digi-link-button--primary-alt': this.afVariation === linkButtonVariation_enum.LinkButtonVariation.PRIMARY_ALT,
            'digi-link-button--secondary-alt': this.afVariation === linkButtonVariation_enum.LinkButtonVariation.SECONDARY_ALT,
            'digi-link-button--medium': this.afSize === linkButtonVariation_enum.LinkButtonSize.MEDIUM,
            'digi-link-button--medium-large': this.afSize === linkButtonVariation_enum.LinkButtonSize.MEDIUMLARGE,
            'digi-link-button--large': this.afSize === linkButtonVariation_enum.LinkButtonSize.LARGE,
            'digi-link-button--hide-icon': this.afHideIcon,
            'digi-link-button--fullwidth': this.afFullwidth
        };
    }
    render() {
        return (index.h(index.Host, { key: 'd6b967617a3fa6a8d5ba68b7982ee2ae4eeef847', class: Object.assign({ 'digi-link-button': true }, this.cssModifiers) }, !this.afLinkContainer && (index.h("a", { key: 'd95e231a794a57b16e888fa98a12b0b0f91cf385', href: this.afHref, onClick: (e) => this.clickLinkHandler(e), ref: (el) => (this._link = el) }, index.h("span", { key: 'db4bb1a99b20e1ae08662da723305814545d0346', class: "digi-link-button__text" }, index.h("slot", { key: 'd1e690a82f45e4b96fb03582185c3ed9a7836fa1' })), this.hasNotification && index.h("slot", { key: '606d2b8c3709f80ca01ffbe5ed34d07e64cdb914', name: "notification" }), index.h("digi-icon-chevron-right", { key: '0bbcaa4fd33ea271f622435ab16d7792111114c0', class: "digi-link-button__icon" }))), this.afLinkContainer && (index.h(index.Fragment, { key: 'cb86ba19e8750179007c79255312e051a4c5edee' }, index.h("slot", { key: '21aa062ab6de4eac5e3d5abf9051ebcb2ea99b4d' }), this.hasNotification && index.h("slot", { key: 'a08beeb67df365a0830da1f87d623876b34675f9', name: "notification" })))));
    }
    get hostElement() { return index.getElement(this); }
};
LinkButton.style = DigiLinkButtonStyle0;

exports.digi_link_button = LinkButton;
