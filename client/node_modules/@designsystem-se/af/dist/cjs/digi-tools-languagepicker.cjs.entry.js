...
const ToolsLanguagepicker = class {
    constructor(hostRef) {
        ...
        this.afId = randomIdGenerator_util.randomIdGenerator('digi-tools-languagepicker');
    ...
    setLanguagePickerIcon() {
        ...
        return index.h("digi-icon-language-outline", null);
    }
    componentWillLoad() {
    ...
    render() {
        return (index.h("div", { key: 'f9f8a82bf6ff533a1351f58e43feb9a9975f3b17', class: Object.assign({ 'digi-tools-languagepicker': true }, this.cssModifiers) }, this._afLanguagepickerHide === false && (index.h("digi-navigation-context-menu", { key: '18667e2f55d8a221847bf0d8da2ecb464c3d4563', afText: this._afLanguagepickerText, afId: this._afId + '__languagepicker', afStartSelected: this._afLanguagepickerStartSelected, afNavigationContextMenuItems: this._afLanguagepickerItems, afIcon: this._languagepickerIcon, onAfOnActive: (event) => this.afOnActive.emit(event.detail), onAfOnBlur: (event) => this.afOnBlur.emit(event.detail), onAfOnChange: (event) => this.afOnChange.emit(event.detail), onAfOnInactive: (event) => this.afOnInactive.emit(event.detail), onAfOnSelect: (event) => this.afOnSelect.emit(event.detail), onAfOnToggle: (event) => this.afOnToggle.emit(event.detail), class: "digi-tools-languagepicker__context" })), this._afListenShow && (index.h("digi-button", { key: '4eafb707710d6f50bca516c49d964b336b68b80e', "af-size": "medium", "af-variation": "primary", onAfOnClick: (event) => {
                this.afOnClick.emit(event);
            }, onAfOnBlur: (event) => {
                this.afOnBlur.emit(event);
            }, onAfOnFocus: (event) => {
                this.afOnFocus.emit(event);
            }, "af-id": this._afId + '__listenButton', class: `digi-tools-languagepicker__buttons ${this._hideButtonText ? 'hide-text' : ''}` }, index.h("digi-icon-volume", { key: '5c0d42d19823d1521c91c29862360ce1ca016ce7', slot: "icon" }), this._afListenText)), this._afSignlangHide === false && (index.h("digi-button", { key: '9053a1f9220db13761cc01558c69ac0b37a3bad7', "af-size": "medium", "af-variation": "primary", onAfOnClick: (event) => {
                this.afOnClick.emit(event);
            }, onAfOnBlur: (event) => {
                this.afOnBlur.emit(event);
            }, onAfOnFocus: (event) => {
                this.afOnFocus.emit(event);
            }, "af-id": this._afId + '__signlangButton', class: `digi-tools-languagepicker__buttons ${this._hideButtonText ? 'hide-text' : 'show-text'}` }, index.h("digi-icon-sign", { key: 'cc527644d8d5cb58372774965dfb542abc55356c', slot: "icon" }), this._afSignlangText))));
    }
...
ToolsLanguagepicker.style = DigiToolsLanguagepickerStyle0;

exports.digi_tools_languagepicker = ToolsLanguagepicker;
