...
const BadgeNotification = class {
    ...
    get cssModifiers() {
        return {
            'digi-badge-notification--circle': this.afShape === badgeNotificationShape_enum.BadgeNotificationShape.CIRCLE,
            'digi-badge-notification--oval': this.afShape === badgeNotificationShape_enum.BadgeNotificationShape.OVAL,
            'digi-badge-notification--pill': this.afShape === badgeNotificationShape_enum.BadgeNotificationShape.PILL
        };
    }
    componentWillLoad() {
        this.checkProps();
    ...
    checkProps() {
        let valueAsNumber;
        if (this.afValue !== null &&
            this.afValue !== undefined &&
            this.afValue !== '') {
            valueAsNumber = Number(this.afValue);
        }
        if (!isNaN(valueAsNumber)) {
            if (valueAsNumber >= 100) {
                ...
                this.afShape = badgeNotificationShape_enum.BadgeNotificationShape.OVAL;
            }
            else {
                this.afShape = badgeNotificationShape_enum.BadgeNotificationShape.CIRCLE;
            }
        }
        else {
            this.afShape = badgeNotificationShape_enum.BadgeNotificationShape.PILL;
    ...
    render() {
        return (index.h(index.Host, { key: '2a3f82fe0bf3d3b43ee858a0184fb7d0045656f7' }, index.h("div", { key: 'f652cc5b76bdc72b4778fd16a1a9d270fe2400ea', class: Object.assign({ 'digi-badge-notification': true }, this.cssModifiers), "aria-label": this.afAriaLabel }, index.h("div", { key: 'ece907bc0004e24eafd221ead41300f7acd803ea', class: `${this.afShape}` }, index.h("span", { key: 'c83210ebbbcad768073095e52b601adc80a0645d' }, this.afValue)))));
    }
    static get watchers() { return {
        "afValue": ["afValueChangeHandler"]
    }; }
};
BadgeNotification.style = DigiBadgeNotificationStyle0;

exports.digi_badge_notification = BadgeNotification;
