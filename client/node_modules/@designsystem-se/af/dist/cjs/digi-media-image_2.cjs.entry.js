...
const DigiMediaImageStyle0 = mediaImageCss;

const MediaImage = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.afOnLoad = index.createEvent(this, "afOnLoad", 7);
    ...
    render() {
        return (index.h("host", { key: '176a863eb81268502c88beb4829d09549a1358da' }, index.h("div", { key: '6bd74e9c48fb6d75eb626f14bdb5821266672ea9', class: Object.assign({ 'digi-media-image': true }, this.cssModifiers), style: {
                '--digi--media-image--width': this.afWidth
                    ? `${this.afWidth}px`
                    : null
            } }, index.h("digi-util-intersection-observer", { key: '8ce033f791396743748641b89d0afa1c442517ae', class: "digi-media-image__observer", onAfOnIntersect: () => this.intersectHandler(), afOnce: true, afOptions: this.afObserverOptions }), this.hasAspectRatio && (index.h("div", { key: 'fdb9d3cb09ca5b3c23659c1503e75c2d22cc87a9', class: "digi-media-image__padded-box", style: this.cssInlineStyles })), index.h("img", { key: '667b7af95611c135fd7d8a99810f84a19c264b83', class: "digi-media-image__image", onLoad: (e) => this.loadHandler(e), src: this.src, alt: this.afAlt, "aria-label": this.afAriaLabel, height: this.afHeight, srcset: this.srcset, title: this.afTitle, width: this.afWidth, loading: this.afUnlazy ? 'eager' : 'lazy' }))));
    }
    static get watchers() { return {
        "afSrc": ["srcChangeHandler"]
    }; }
};
MediaImage.style = DigiMediaImageStyle0;
...
const UtilIntersectionObserver = class {
    ...
    render() {
        return index.h("slot", { key: 'd3a3eebd7c8eaa2ad5b0ce8a0358974acf462223' });
    }
...
exports.digi_media_image = MediaImage;
