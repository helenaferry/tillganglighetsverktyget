...
const ContextMenu = class {
    ...
    handleToggle() {
        ...
        if (this.visible) {
            this.hideMenu();
            (_b = (_a = this.buttonRef).focus) === null || _b === void 0 ? void 0 : _b.call(_a);
        }
        else {
            this.showMenu();
    ...
    syncActiveItem() {
        if (this.afActiveItem != null) {
            this.activeItemIdx = this.items.findIndex((item) => item.id.toString() === this.afActiveItem);
        }
    }
    syncItems() {
        this.items = deserializeProp(this.afMenuItems);
    }
    componentWillLoad() {
        this.syncItems();
        this.syncActiveItem();
    ...
    render() {
        return (index.h(index.Host, { key: 'b56dc8e0ca38fa90bf6ac4495b9fb583e00b75ed', id: `${this.afId}-identifier` }, index.h("digi-navigation-dropdown", { key: 'f4fe5c1f4812ae2ab492f5ff1159716cafceae68', afAriaLabelledby: `${this.afId}-trigger`, afId: this.afId, afItems: this.items, afVisible: this.visible, afMenuPosition: this.afMenuPosition, afDir: this.afDir, afActiveItem: this.activeItemIdx, afLang: this.afLang, onAfRef: (e) => this.handleRef(e.detail.ref, e.detail.id, e.detail.payload), onAfChangeItem: (e) => this.handleChangeItem(e.detail.item, e.detail.idx), onAfFocusItem: (e) => this.handleFocusItem(e.detail.item, e.detail.idx), afRenderItem: (item, idx) => {
                ...
                return (index.h(Container, Object.assign({ class: "content-wrapper" }, containerArgs), showIcon && (index.h("digi-icon-check", { class: "digi-navigation-context-menu__button-icon", slot: "icon", style: {
                        visibility: idx === this.activeItemIdx && this.visible
                            ? 'visible'
                            : 'hidden'
                    } })), index.h("p", null, item.title)));
            } }, index.h("digi-button", { key: '6ca8a9350d6a040713e1601c2df874c61883f964', id: `${this.afId}-trigger`, afInputRef: (ref) => (this.buttonRef = ref), onClick: () => this.handleToggle(), afVariation: "function", afAriaControls: `${this.afId}-listbox`, afAriaExpanded: this.visible, afAriaLabel: this.afAriaLabel || null, class: {
                'digi-navigation-context-menu__trigger-button': true,
                'digi-navigation-context-menu--active': this.visible
            } }, !!this.afIcon && index.h(this.digiIcon, { key: '23ac109788a00edb22f2a2847c2ab1568abba4c3', slot: "icon" }), this.afTitle, index.h("digi-icon-chevron-down", { key: 'fc7fa776933779e29da3e7fc64d010fa0c65261d', class: "digi-navigation-context-menu__toggle-icon", slot: "icon-secondary" })))));
    }
