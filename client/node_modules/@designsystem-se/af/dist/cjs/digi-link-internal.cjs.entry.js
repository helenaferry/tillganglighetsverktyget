...
const linkInternalVariation_enum = require('./link-internal-variation.enum-96d004ec.js');
...
const LinkInternal = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'c495c1cbe9f2aaa37dcaac0360f5376e2c36bb1f' }, !this.afLinkContainer && (index.h("digi-link", { key: 'f139f5828022d9c88dedced8fe6da890d709cca4', class: Object.assign({ 'digi-link-internal': true }, this.cssModifiers), afVariation: this.afVariation, afHref: this.afHref, afOverrideLink: this.afOverrideLink, afLinkContainer: this.afLinkContainer, onAfOnClick: (e) => this.clickLinkHandler(e), afDescribedby: this.afDescribedby, afAriaLabel: this.afAriaLabel }, index.h("digi-icon-chevron-right", { key: '7d25477644ea201f93e32dd62f5ac56ffeb9143f', class: "digi-link-internal__icon", "aria-hidden": "true", slot: "icon" }), index.h("slot", { key: '29b65b32f3a42106bf544ecef20e8d21263aeeab' }))), this.afLinkContainer && (index.h("digi-link", { key: 'bf064e97bc2946f9cb5d2a60867875073449e913', afVariation: this.afVariation, afHref: this.afHref, afOverrideLink: true, afLinkContainer: this.afLinkContainer, onAfOnClick: (e) => this.clickLinkHandler(e), afDescribedby: this.afDescribedby, afAriaLabel: this.afAriaLabel }, index.h("slot", { key: '33d8626613e4e62c787fc5073244a090db343a01' })))));
    }
