...
const Calendar = class {
    ...
    cssDateModifiers(date) {
        return {
            ...
            'digi-calendar__date--not-selectable': !this.isDisabledDate(date) && !this.isDateSelectable(date)
        };
    }
    render() {
        return (index.h("div", { key: 'bf40fc1bac26c7a1fd36af8163ca900ad716f2ac', class: {
                'digi-calendar': true,
                'digi-calendar--hide': !this.afActive
            }, id: `${this.afId}-calendar` }, this.afYearSelect && (index.h("div", { key: '5c5a3d9b92e2cad5d5d0891773245199ff2f270d', class: "digi-calendar__header" }, index.h("div", { key: 'a8220cc1f247d952d987eebc64b66a85f9b8fa0e', class: "digi-calendar__header--year-select" }, index.h("digi-form-select", { key: 'e74b195443677f7e7653e159be212dc762721ddf', afLabel: "M\u00E5nad", "af-variation": "small", afValue: this.focusedDate.getMonth().toString(), onAfOnSelect: (evt) => {
                this.selectMonth(evt);
            } }, this.months.map((month, index$1) => {
            return index.h("option", { value: index$1 }, month);
        })), index.h("digi-form-select", { key: 'f8997fd8f662111f681bfea97fa6c8da4833dbd7', afLabel: "\u00C5r", "af-variation": "small", afValue: this.focusedDate.getFullYear().toString(), onAfOnSelect: (evt) => {
                this.selectYear(evt);
            }, ref: (el) => (this._yearSelect = el) }, this.allSelectableYears().map((year) => (index.h("option", { value: year.toString() }, year))))))), !this.afYearSelect && (index.h("div", { key: '6357428160019c55994d797d3d17c7155572a11e', class: "digi-calendar__header" }, index.h("div", { key: '8ba1925cdbf55c492a2fe0793145782ee4c1eb71', class: "digi-calendar__header--month-step" }, index.h("button", { key: 'c35f9f23abd8560a716e6fd45bbbe32281cdc220', class: "digi-calendar__month-select-button", type: "button", "aria-label": this.getFullMonthName(this.afInitSelectedMonth - 1) +
                ', föregående månad', onClick: () => this.subtractMonth() }, index.h("digi-icon-chevron-left", { key: 'bb1685a8b70c6ba74d5ff649ac5fe15404f10433', slot: "icon", "aria-hidden": "true" }), index.h("span", { key: '793236bdad8c199474057adbabf3cc62509c00a2', class: "digi-calendar__month-select-name" }, this.getMonthName(this.afInitSelectedMonth - 1))), index.h("div", { key: '6e0fcb86956a89bdf7c18d30365b524b1679b952', class: "digi-calendar__month" }, this.getFullMonthName(this.afInitSelectedMonth)), index.h("button", { key: '155c99f0c5f1aacac09a15733477a5aa470f27bc', class: "digi-calendar__month-select-button", type: "button", "aria-label": this.getFullMonthName(this.afInitSelectedMonth + 1) +
                ', nästa månad', onClick: () => this.addMonth(), ref: (el) => (this._nextButton = el) }, index.h("span", { key: 'cb7449a1b1be88b4b9c06d8d483e7ecae59ee42c', class: "digi-calendar__month-select-name" }, this.getMonthName(this.afInitSelectedMonth + 1)), index.h("digi-icon-chevron-right", { key: 'b698289d59f9f934e5f936958b15d606e72df3b2', slot: "icon", "aria-hidden": "true" }))))), index.h("digi-util-keydown-handler", { key: 'a6af325d76e3b441eb9dfa75dc7fc39d508d7393', onAfOnDown: (e) => this.navigateHandler(e, 7), onAfOnUp: (e) => this.navigateHandler(e, -7), onAfOnLeft: (e) => this.navigateHandler(e, -1), onAfOnRight: (e) => this.navigateHandler(e, 1), onAfOnShiftTab: () => this.shiftTabHandler() }, index.h("table", { key: 'aa61779c152a1c13ed768bc84ccc8fc05c826872', role: "grid", class: "digi-calendar__table" }, index.h("thead", { key: '1e653248ff572c0bcc36823a2a5a5fac0878b3bf' }, index.h("tr", { key: '4ab2c169027c83cb5dc4b5d1031f0c9f7b965a7f' }, this.afShowWeekNumber && (index.h("th", { key: 'f9a6bcd38bc852fef8f924cc2faaee108aaabcfa', role: "gridcell", abbr: text._t.calendar.week, class: "digi-calendar__table-header-week" }, text._t.calendar.week.toLowerCase())), Object.keys(text._t.calendar.weekdays).map((day) => (index.h("th", { role: "gridcell", abbr: text._t.calendar.weekdays[day], class: "digi-calendar__table-header" }, text._t.calendar.weekdays_short[day].toLowerCase()))))), index.h("tbody", { key: 'feef4137f6cf96b69c996dfd83631c4086ad4a88', ref: (el) => (this._tbody = el) }, this.activeCalendar.map((week) => {
            return (index.h("tr", null, week.map((day, i) => {
                if (this.afShowWeekNumber && i === 0) {
                    return (index.h("td", { role: "gridcell", class: "digi-calendar__td-week digi-calendar__date--week-number", id: 'digi-calendar__week-' + day }, day));
                }
                else {
                    return (index.h("td", { role: "gridcell", class: "digi-calendar__td" }, index.h("button", { type: "button", class: Object.assign(Object.assign({}, this.cssDateModifiers(day)), { 'digi-calendar__date': true }), onClick: () => this.selectDateHandler(day), "aria-label": this.getDateName(day), "aria-disabled": this.isDisabledDate(day) ||
                            !this.isDateSelectable(day), "aria-describedby": this.afShowWeekNumber && i === 1
                            ? 'digi-calendar__week-' + week[0]
                            : null, tabindex: this.setTabIndex(day), "data-date": this.getFullDate(day), "aria-pressed": this.ariaPressed(day) }, index.h("span", { "aria-hidden": "true" }, day.getDate()))));
                }
            })));
        })))), index.h("slot", { key: '11b292ce91704016dd1a3e214160d8bc84e28b17', name: "calendar-footer" })));
    }
...
const iconCalendarAltCss = ".sc-digi-icon-calendar-alt-h{--digi--icon--color:var(--digi--color--icons--primary);--digi--icon--width:initial;--digi--icon--height:auto;display:flex;min-height:1.4em;align-items:center}.sc-digi-icon-calendar-alt-h svg.sc-digi-icon-calendar-alt{color:var(--digi--icon--color);max-width:var(--digi--icon--width);max-height:var(--digi--icon--height);width:var(--digi--icon--width, auto);height:var(--digi--icon--height, auto)}";
...
const IconCalendarAlt = class {
    ...
    render() {
        return (index.h("svg", { key: 'a6e9eb03f5990e3c3f9282b49ca1c07389ae5cca', class: "digi-icon-calendar-alt", width: "22", height: "26", viewBox: "0 0 22 26", "aria-hidden": this.afSvgAriaHidden ? 'true' : 'false', "aria-labelledby": this.afSvgAriaLabelledby
                ? this.afSvgAriaLabelledby
                : this.afTitle
                    ? this.titleId
                    : undefined, xmlns: "http://www.w3.org/2000/svg" }, this.afTitle && index.h("title", { key: 'def5a3843ac983388955b43e4a5acaa78d173e67', id: this.titleId }, this.afTitle), this.afDesc && index.h("desc", { key: '33409cd92598b447484fb5291edfe8cdaa3e2328' }, this.afDesc), index.h("path", { key: '060816bc689e7eafb584e68943211acbacb8dfaa', class: "digi-icon-calendar-alt__shape", d: "M21.41 8.125H.59a.601.601 0 01-.59-.61V5.689C0 4.341 1.056 3.25 2.357 3.25h2.357V.61c0-.336.265-.61.59-.61h1.964c.324 0 .59.274.59.61v2.64h6.285V.61c0-.336.265-.61.59-.61h1.963c.325 0 .59.274.59.61v2.64h2.357C20.944 3.25 22 4.342 22 5.688v1.828c0 .335-.265.609-.59.609zM.59 9.75h20.82c.325 0 .59.274.59.61v13.203C22 24.907 20.944 26 19.643 26H2.357C1.056 26 0 24.908 0 23.562V10.36c0-.335.265-.609.59-.609zm5.696 10.36a.601.601 0 00-.59-.61H3.732a.601.601 0 00-.59.61v2.03c0 .336.266.61.59.61h1.964c.325 0 .59-.274.59-.61v-2.03zm0-6.5a.601.601 0 00-.59-.61H3.732a.601.601 0 00-.59.61v2.03c0 .336.266.61.59.61h1.964c.325 0 .59-.274.59-.61v-2.03zm6.285 6.5a.601.601 0 00-.589-.61h-1.964a.601.601 0 00-.59.61v2.03c0 .336.266.61.59.61h1.964c.324 0 .59-.274.59-.61v-2.03zm0-6.5a.601.601 0 00-.589-.61h-1.964a.601.601 0 00-.59.61v2.03c0 .336.266.61.59.61h1.964c.324 0 .59-.274.59-.61v-2.03zm6.286 6.5a.601.601 0 00-.59-.61h-1.963a.601.601 0 00-.59.61v2.03c0 .336.265.61.59.61h1.964c.324 0 .59-.274.59-.61v-2.03zm0-6.5a.601.601 0 00-.59-.61h-1.963a.601.601 0 00-.59.61v2.03c0 .336.265.61.59.61h1.964c.324 0 .59-.274.59-.61v-2.03z", fill: "currentColor", "fill-rule": "nonzero" })));
    }
};
