const contentTypeTexts = [
  {
    ...
    prefillComment:
      'Kravet har förifyllts som irrelevant eftersom tjänsten, enligt tidigare ifyllda uppgifter, saknar bilder, ikoner och grafik.',
  },
  {
    contentType: 'Formulär & inmatningsfält',
    question: 'Innehåller tjänsten formulär eller inmatningsfält?',
    prefillComment:
      'Kravet har förifyllts som irrelevant eftersom tjänsten, enligt tidigare ifyllda uppgifter, saknar formulär och inmatningsfält.',
  },
  {
    contentType: 'Mediaspelare Ljud',
    question: 'Innehåller tjänsten ljud?',
    prefillComment:
      'Kravet har förifyllts som irrelevant eftersom tjänsten, enligt tidigare ifyllda uppgifter, saknar ljud.',
  },
  {
  ...
  },
  {
    ...
    prefillComment:
      'Kravet har förifyllts som irrelevant eftersom tjänsten, enligt tidigare ifyllda uppgifter, saknar möjlighet att publicera innehåll eller lämna kommentar.',
  },
];
